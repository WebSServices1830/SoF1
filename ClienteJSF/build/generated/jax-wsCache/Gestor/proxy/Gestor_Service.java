 ...
 * 
 */
@WebServiceClient(name = "Gestor", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/AppFormula1Servidor/Gestor?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/AppFormula1Servidor/Gestor?WSDL");
