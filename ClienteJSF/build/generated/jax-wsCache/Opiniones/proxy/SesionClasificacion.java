 ...
 *         &lt;element name="resultados" type="{http://ws/}resultadoClasificacion" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SesionClasificacion {
    ...
    protected List<ResultadoClasificacion> resultados;
    ...
    public List<ResultadoClasificacion> getResultados() {
        if (resultados == null) {
            resultados = new ArrayList<ResultadoClasificacion>();
        }
