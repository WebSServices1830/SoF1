...
public class ResultadoCarreraFacade extends AbstractFacade<ResultadoCarrera> {
    ...
    public List<ResultadoCarrera> obtenerResultadoCarreraBySesionCarrera(int idSesionCarrera) {
        return getEntityManager().createQuery("select rc "+"from ResultadoCarrera rc "+"where rc.sesionCarrera.idSesionCarrera = :idSesionCarrera"+" order by rc.puntos desc",ResultadoCarrera.class)
